...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $stmt = $conn->prepare(
        "SELECT id, username, password_hash, rola FROM users WHERE username = ?"
    );
    ...
    if ($user = $result->fetch_assoc()) {
        ...
        if (password_verify($password, $user['password_hash']) && $user['rola'] == "admin") {
...
<header>
    <a href=admin_log.php><img src="../images/sportres-logo.png" alt="logo" class="site_logo"></a>
</header>
